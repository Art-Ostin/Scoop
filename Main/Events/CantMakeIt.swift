...
struct CantMakeIt: View {
    ...
    var body: some View {
        ...
        .customAlert(isPresented: $showCancelAlert, title: "Cancel Date",cancelTitle: "Back", okTitle: "Confirm", emoji: "🚨", message: "Are you sure? Scoop will be frozen for two weeks.", showTwoButtons: true) {

            ...
            ZStack {
                TabView(selection: $router.selectedTab) {
                    ...
                    Tab("", image: icon(.events), value: AppTab.events) {
                        EventsContainer(vm: eventsVM, showMessageScreen: $router.showMessageScreen, showEventId: $router.showEventId, path: $router.eventsPath)
                    }

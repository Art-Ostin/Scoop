...
//  Thanks
//  ------
//  Lokesh Dhakar - for the original MMCQColor Thief JavaScript version
...
open class ColorMap {
    ...
    open func makePalette() -> [MMCQColor] {
        return vboxes.map { $0.getAverage() }
    }
    
    open func makeNearestColor(to color: MMCQColor) -> MMCQColor {
        var nearestDistance = Int.max
        var nearestColor = MMCQColor(r: 0, g: 0, b: 0)

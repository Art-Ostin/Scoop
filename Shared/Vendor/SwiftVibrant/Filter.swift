...
public class VibrantFilter {
    ...
    public static func combineFilters (filters: [VibrantFilter])->VibrantFilter? {
        ...
        return VibrantFilter(newFilterFunction)
    }
    
    public static let defaultFilter: VibrantFilter = VibrantFilter({r, g, b, a in

...
// MARK:  Aspect Ratio
enum AspectRatio {
    case square, card, `default`, inviteCard, invitedImage, confirmInviteImage, eventLocationMap, pendingEvent
    ...
    var ratio: CGFloat {
        ...
        case .confirmInviteImage: 1 / 0.8
        case .eventLocationMap:   1 / 1.02
        case .pendingEvent:       1 / 0.8
        }
    }
}

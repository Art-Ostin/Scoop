...
extension Color {
    ...
    static let borderLight = Color(red: 0.94, green: 0.93, blue: 0.92) //A fainter rule for hairlines inside a white card (the pending ledger) — one step lighter than .border, same warm axis.
    ...
    static let canvasSunken = Color(red: 0.97, green: 0.96, blue: 0.95) //Color(red: 0.96, green: 0.95, blue: 0.91) //Recessed canvas for card-on-canvas screens (edit profile, History's pending calendar) — a step deeper and warmer than appCanvas so white cards read as raised.

...
//    
//    init(text: String, isValid: Bool, onTap: @escaping () -> Void, isSendInvite: Bool, cornerRadius: CGFloat = 15) {
//        self.text = text
//        self.isValid = isValid
//        self.onTap = onTap
//        self.isSendInvite = isSendInvite
...
//
//#Preview {
//    ActionButton2(text: "Confirm & Send", isValid: true, onTap: {}, isSendInvite: <#Bool#>)
//}

...
#Preview {
    PromptResponseView(promptSelection: Prompts.instance["on the date"] ?? "Write whatever", promptResponse: "Bannanas and Apples and all the other things", inviteButton: true)

            ...
            GeometryReader { geo in
                ZStack {
                    VStack{
                        ...
                        TabView {
                            PromptResponseView(promptSelection: promptSelection1 ?? "Whatever", promptResponse: "Feeling the beauty of the facticity of life", inviteButton: true, showInvite: $showInvite)
                                    .frame(maxHeight: .infinity, alignment: .top)
                                    
                            PromptResponseView(promptSelection: promptSelection2 ?? "Whatever", promptResponse: "Imagineing something incredible...being Alive", inviteButton: true, showInvite: $showInvite)
                                .frame(maxHeight: .infinity, alignment: .top)
...
#Preview {
    ProfileDetailsView(showInvite: .constant(true))
}

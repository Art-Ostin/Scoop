...
struct LimitedAccessView: View {
    ...
    var body: some View {
        ...
        .fullScreenCover(isPresented: $showOnboarding) {
            OnboardingContainer(vm: EditProfileViewModel(cacheManager: dep.cacheManager, s: dep.sessionManager, userManager: dep.userManager, storageManager: dep.storageManager, draftUser: dep.defaultsManager.draftUser ?? dep.sessionManager.user, defaults: dep.defaultsManager), current: $current)
        }
        .task {

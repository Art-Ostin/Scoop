...
struct LimitedAccessView: View {
    ...
    var body: some View {
        ...
        .fullScreenCover(isPresented: $showOnboarding) {
            OnboardingContainer(vm: EditProfileViewModel(cachManager: dep.cacheManager, s: dep.sessionManager, userManager: dep.userManager, storageManager: dep.storageManager, draftUser: dep.sessionManager.user), current: $current)
        }
        .task {
